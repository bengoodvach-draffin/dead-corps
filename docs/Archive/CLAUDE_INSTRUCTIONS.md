...
**https://github.com/bengoodvach-draffin/dead-corps**

### **Reading Files Directly**

Instead of Ben uploading files, Claude can fetch the latest version of any script directly using raw URLs:

```
https://raw.githubusercontent.com/bengoodvach-draffin/dead-corps/main/scripts/human.gd
https://raw.githubusercontent.com/bengoodvach-draffin/dead-corps/main/scripts/unit.gd
https://raw.githubusercontent.com/bengoodvach-draffin/dead-corps/main/docs/PROJECT_CONTEXT.md
```

**Pattern:** `https://raw.githubusercontent.com/bengoodvach-draffin/dead-corps/main/[path/to/file]`

**When Ben says "fetch X from GitHub"** — use web_fetch with the raw URL above.

### **Workflow for Code Changes**

1. Claude fetches the latest file via raw URL
2. Claude makes changes and outputs the updated file
3. Ben saves the file to his local project
4. Ben commits and pushes in GitHub Desktop
5. Next session: Claude fetches the updated version directly

**Claude cannot push to GitHub** — Ben always handles the commit/push step.
